...
export function buildApps(): DesktopApp[] {
  return [
    // Left dock (4): the "make the proxy work" core — set up providers, feed the
    // pool, expose keys, extend with plugins.
    ...
    // Right dock (5): monitoring, personal, and config.
    ...
    { id: "profile", label: "Profile", icon: <UserCircle />, accent: "from-indigo-500 to-violet-600", home: "right", render: () => <ProfileApp /> },
