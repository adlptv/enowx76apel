...
export function buildApps(): DesktopApp[] {
  return [
    // Left dock: setting up + running the pool (the day-to-day essentials).
    ...
    // Right dock: monitoring + social + config.
    ...
    // Drawer: everything else (open from the Apps drawer or drag onto a dock).
